inherited frmCadDizimos: TfrmCadDizimos
  ...
  object fdqryCargos: TFDQuery
    ...
    Left = 376
    Top = 152
    object strngfldCargoslist: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'list'
      Origin = '`list`'
      ProviderFlags = []
    ...
    object strngfldCargoscargo_pessoa: TStringField
      FieldKind = fkLookup
      FieldName = 'cargo_pessoa'
      LookupDataSet = fdqryPessoa
  ...
  object fdqryPessoa: TFDQuery
    ...
    SQL.Strings = (
      'SELECT cod_pessoa, nome_pessoa, '
        ...
        'a.cod_congregacao, cod_situacao,case when d.cargo is null then '#39 +
        'MEMBRO'#39' else  d.cargo end as cargo'
      'FROM igreja.tb_pessoa a '
      
        'inner join tb_parametro_sistema b on a.cod_congregacao = b.cod_c' +
        'ongregacao'
      'left join tb_obreiro_cargo c on c.`COD_MEMBRO` = a.cod_pessoa'
      'left join tb_cargo d on d.cod_cargo = c.`COD_CARGO`'
      'order by nome_pessoa')
    Left = 441
    Top = 112
    object intgrfldPessoacod_pessoa: TIntegerField
      AutoGenerateValue = arDefault
    ...
    object intgrfldPessoacod_congregacao: TIntegerField
      FieldName = 'cod_congregacao'
      Origin = 'cod_congregacao'
      Required = True
    end
    object intgrfldPessoacod_situacao: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'cod_situacao'
      Origin = 'cod_situacao'
    end
    object strngfldPessoacargo: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'cargo'
      Origin = 'cargo'
      ProviderFlags = []
