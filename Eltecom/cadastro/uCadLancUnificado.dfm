object frmCadLancUnificado: TfrmCadLancUnificado
  Left = 0
  Top = 0
    ...
    object tabManutencao: TTabSheet
      ...
      object pnl1: TPanel
        ...
        object lblCultoFornec: TLabel
          ...
          Width = 124
          Height = 13
          Caption = 'Dia ou na lideran'#231'a do(a):'
        end
        ...
        object lbledtCodTalao: TLabeledEdit
          ...
          EditLabel.Width = 89
          EditLabel.Height = 13
          EditLabel.Caption = 'NFe / Documento*'
          NumbersOnly = True
          TabOrder = 1
        end
        ...
        object dblkcbbCultoFornec: TDBLookupComboBox
          Left = 248
          Top = 23
          Width = 301
          Height = 21
        ...
        object dblkcbbCC: TDBLookupComboBox
          Left = 6
          Top = 109
          Width = 171
          Height = 21
        ...
        object dblkcbbTipoGenerico: TDBLookupComboBox
          Left = 183
          Top = 109
          Width = 171
          Height = 21
        ...
        object dblkcbbFormPag: TDBLookupComboBox
          Left = 360
          Top = 109
          Width = 189
          Height = 21
          ListSource = dsFormpgto
          TabOrder = 10
        end
        object dblkcbbConf1: TDBLookupComboBox
          Left = 6
          Top = 179
          Width = 339
          Height = 21
        ...
        object dblkcbbConf2: TDBLookupComboBox
          Left = 351
          Top = 179
          Width = 339
          Height = 21
  ...
  object dsCultoFornec: TDataSource
    Left = 624
    Top = 216
  end
  object dsFormpgto: TDataSource
    Left = 392
    Top = 224
  end
