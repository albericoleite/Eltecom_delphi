...
uses
  ...
  FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, uDTMConexao,
  FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt,cAcaoAcesso, uEnum,
...
begin
 if oAcaoAcesso.Selecionar(QryListagem.FieldByName('cod_acao_acesso').AsInteger) then
...
begin
      ...
      if lbledtCodigo.Text<>EmptyStr then
       ...
       oAcaoAcesso.chave:=  lbledtChave.Text ;
         ...
         if oAcaoAcesso.ChaveExiste(lbledtChave.Text,oAcaoAcesso.cod_acao_acesso) then begin
